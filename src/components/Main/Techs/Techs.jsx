...
function Techs(props) {
  return (
    <>
      <Section className={styles.techs} title='Технологии'>
        <h3 className={styles.techs__title}>7 технологий</h3>
        <p className={styles.techs__paragraph}>На курсе веб-разработки мы освоили технологии, которые применили в дипломном проекте.</p>
